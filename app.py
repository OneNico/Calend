...
def main():
    ...
    # El DataFrame filtrado es ahora el DataFrame completo
    ...
    with tab1:
        ...
        if not tasks_to_show:
            ...
            <div class="custom-alert alert-info">
                ℹ️ No hay tareas pendientes o vencidas para mostrar.
            </div>
            """, unsafe_allow_html=True)
        else:
    ...
    # TAB 3: REGISTRO
    with tab3:
        st.markdown("### ✅ Registro de Tareas Completadas")
        ...
        if completed_tasks_df.empty:
            st.markdown("""
            <div class="custom-alert alert-info">
                ℹ️ No hay tareas completadas para mostrar.
            </div>
            """, unsafe_allow_html=True)
        else:
